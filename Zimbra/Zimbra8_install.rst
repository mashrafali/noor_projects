## page was renamed from Enterprise/IT/Docs/How_To/Linux/Zimbra 8
## page was renamed from Enterprise/IT/Docs/HowTo/Linux/Zimbra8/Zimbra_install
## page was renamed from Enterprise/IT/Docs/How_To/Linux/Zimbra8/Zimbra_install
{{{
Author       : Amr Mohsen
Version      : 1.1
...
IP-address      smtp.noorgroup.com         zimb1
...
{{{
tar xzvf zcs-8.0.0_GA_5434.UBUNTU12_64.20120907144631.tgz
}}}
...
=== Note : you must use zimbra account ===
{{{
su zimbra
}}}
...
=== How to get all domain ===
{{{
zmprov gad -V
}}}
=== How to delete domain ===
{{{
zmprov dd example.com
}}}
=== how to add noor accounts ===
Note:make sure you in the correct path , the default pass of user zimbra --> /opt/zimbra/
=== How to add distribution list ===
{{{
zmprov < dl.txt
}}}
=== How to add members ===
{{{
zmprov < dlmembers.txt
}}}
=== How to add aliases ===
{{{
zmprov < alias.txt
