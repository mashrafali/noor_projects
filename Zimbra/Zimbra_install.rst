## page was renamed from Enterprise/IT/TechDocs/HowTo/Linux/Zimbra/Zimbra_install
## page was renamed from Enterprise/IT/Docs/HowTo/Linux/Zimbra/Zimbra_install
## page was renamed from Enterprise/IT/Docs/How_To/Linux/Zimbra/Zimbra_install
{{{
...
'''Server IP Address:''' 41.187.101.68
...
41.187.101.68   smtp.noor.net zimb1
...
To download and install Zimbra run below commands:

=== Dowload the Zimbra 7 Package ===
{{{
wget http://files2.zimbra.com/downloads/7.2.0_GA/zcs-7.2.0_GA_2669.UBUNTU10_64.20120410002303.tgz
}}}
...
{{{
tar xzvf zcs-7.2.0_GA_2669.UBUNTU10_64.20120410002303.tgz
}}}
=== Install prerequisites packages ===
{{{
apt-get install libgmp3c2 libexpat1 libperl5.10 sysstat sqlite3
}}}
=== If you will install zimbra 8 on ubuntu server 12.04 you must Install liperl5.14 ===
{{{
